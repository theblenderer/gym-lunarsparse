...
# Adaptation to make sparse rewards by Daniel Groothuysen
...
class LunarSparseEnv(gym.Env, EzPickle):
    metadata = {
...
class LunarLanderContinuous(LunarSparseEnv):
    continuous = True
...
if __name__ == '__main__':
    demo_heuristic_lander(LunarSparseEnv(), render=True)
...
class LunarSparseEnv(gym.Env, EzPickle):
    ...
    def step(self, action):
        ...
        # Adapted reward to make sparse, no reward shaping
        reward = -1
